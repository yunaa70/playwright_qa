...
test.describe('01. 로그인', () => {
  ...
  test('[TC-LOGIN-001] 정상 계정으로 로그인하면 상품 목록으로 이동한다', async ({ page }) => {
  ...
  test('[TC-LOGIN-005] 틀린 비밀번호로 로그인하면 에러가 표시된다', async () => {
